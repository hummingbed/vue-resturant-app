<template>
  ...
  <div v-for="name in userName" :key="name">
    {{ name.name }}
  </div>
              ...
              <div class="flip-card__container">
                <div class="card-front">
                  <div class="card-front__tp card-front__tp--city">
                    <h2 class="card-front__heading">{{ resturant.name }}</h2>
                  ...
                  <div class="card-front__bt">
                    <p
                      class="card-front__text-view card-front__text-view--city"
                    >
                      View me
                    </p>
                  </div>
...
export default {
  ...
  mounted() {
    ...
    let endPoint = "http://localhost:3000/resturant";
